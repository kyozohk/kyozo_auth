...
interface Community {
    ...
    usersList?: any[]; // Firestore
    memberCount?: number; // Mongo
    data?: any;
    [key: string]: any;
}
...
export function CommunityListInbox({ title, communities, isLoading, selectedCommunityId, onCommunitySelect, isMongo = false }: CommunityListProps) {
  ...
  const handleCopy = (community: Community) => {
    navigator.clipboard.writeText(JSON.stringify(community.data || community, null, 2));
    toast({
  ...
  return (
    <>
      <CardHeader className="p-0 mb-4">
          ...
          <CardDescription>Select a community to view details</CardDescription>
      </CardHeader>
                        ...
                        <div className='flex items-center space-x-3'>
                          ...
                          <div className='flex-1 truncate'>
                            ...
                            <p className='text-xs text-muted-foreground'>
                                {isMongo ? community.memberCount : community.usersList?.length || 0} members
                            </p>
                          </div>
                        </div>
                    </Button>
